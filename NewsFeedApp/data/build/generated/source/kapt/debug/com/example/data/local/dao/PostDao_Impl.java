...
public final class PostDao_Impl implements PostDao {
  ...
  public PostDao_Impl(@NonNull final RoomDatabase __db) {
    ...
    this.__insertionAdapterOfPostEntity = new EntityInsertionAdapter<PostEntity>(__db) {
      ...
      protected String createQuery() {
        return "INSERT OR REPLACE INTO `posts` (`id`,`title`,`content`) VALUES (?,?,?)";
      }
  ...
  @Override
  public Object getAllPosts(final Continuation<? super List<PostEntity>> $completion) {
      ...
      public List<PostEntity> call() throws Exception {
        ...
        try {
          ...
          while (_cursor.moveToNext()) {
            ...
            _item = new PostEntity(_tmpId,_tmpTitle,_tmpContent);
            _result.add(_item);
          }
          return _result;
        } finally {
